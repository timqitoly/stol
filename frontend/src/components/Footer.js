        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 text-center md:text-left">
            <div>
              <div className="flex items-center justify-center md:justify-start space-x-4 mb-4">
                ...
                <h3 className="text-xl font-bold">{mockData.company.name}</h3>
              </div>
              <p className="text-amber-200">{mockData.company.tagline}</p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-amber-200">
                <p>{mockData.company.phone}</p>
                <p>{mockData.company.email}</p>
          ...
          <div className="border-t border-amber-800 mt-8 pt-8 text-center">
            <p className="text-amber-300">
              © 2024 {mockData.company.name}. Все права защищены.
            </p>
            <div className="mt-2">
